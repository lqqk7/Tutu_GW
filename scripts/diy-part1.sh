...
cp "$GITHUB_WORKSPACE/patches/luci-i18n/ddns-go.zh_Hans.po" package/luci-app-ddns-go/luci-app-ddns-go/po/zh_Hans/ddns-go.po

# Advanced Plus
git clone --depth=1 https://github.com/sirpdboy/luci-app-advancedplus.git package/luci-app-advancedplus
cp "$GITHUB_WORKSPACE/patches/luci-i18n/advancedplus.zh_Hans.po" package/luci-app-advancedplus/po/zh_Hans/advancedplus.po
...
cp "$GITHUB_WORKSPACE/patches/luci-i18n/autoupdate.zh_Hans.po" package/luci-app-autoupdate/po/zh_Hans/autoupdate.po
